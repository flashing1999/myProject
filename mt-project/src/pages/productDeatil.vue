<template>
<div v-if="productList.length" class="page-product">
    <dl class="s-item" v-for="item in productList" :key="item.address">
      <dt>
      ...
      <dd>
        ...
        <p>
          ...
          <span>很好</span>
          <span class="s-item-comment-total">{{  }}人评论</span>
        </p>
        <p>
...
export default {
  ...
  mounted () {
    ...
    api.getProductList.then((res) => {
      this.productList.push(res[this.$route.params.index])
    })
  }
}
</script>
